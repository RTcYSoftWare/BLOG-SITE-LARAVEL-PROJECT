...
@section("content")
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary float-right"><strong>Site İçi Ayarları</strong>
            </h6>
        </div>
        <div class="card-body">
            <form method="POST" action="{{route("admin.config.update")}}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-block btn-success">Site Ayarlarını Güncelle</button>
                    </div>
                </div>
            </form>
        </div>
